    ...
    return (
        <div className="w-full flex flex-col items-center">
            <div className="w-full flex justify-end gap-4 text-[10px] font-bold text-slate-500 mb-2">
                <span className="flex items-center gap-1"><div className="w-3 h-3 bg-blue-600 rounded-sm"></div>Sucata Limpa ({(100 - impurezaPct).toFixed(0)}%)</span>
            ...
            <div className="relative w-full max-w-lg h-64 border-b border-slate-200 dark:border-slate-700" >
                <div className="absolute bottom-[40px] left-[20px] right-[80px] h-[160px] flex flex-col-reverse justify-start overflow-hidden opacity-90 rounded-sm">
